                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <div className="flex items-center gap-4 h-6">
                          {(() => {
                            ...
                            if (currentPrice < product.price) {
                              return (
                                <div className="flex items-baseline gap-3">
                                  <span className="text-[11px] text-ink font-mono font-semibold tracking-tight tabular-nums whitespace-nowrap">{formatPrice(currentPrice)}</span>
                            ...
                            return <span className="text-[11px] text-ink font-mono font-semibold tracking-tight tabular-nums whitespace-nowrap">{formatPrice(product.price)}</span>;
                          })()}
                        </div>
                      </div>
